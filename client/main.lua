...
AddEventHandler('esx:onPlayerSpawn', function()
	...
	if firstSpawn then
		...
		if Config.SaveDeathStatus then
			...
			ESX.TriggerServerCallback('esx_firejob:getDeathStatus', function(shouldDie)
				if shouldDie then
					Wait(1000)
...
RegisterNetEvent('esx_firejob:clsearch')
AddEventHandler('esx_firejob:clsearch', function(medicId)
	local playerPed = PlayerPedId()
...
function OnPlayerDeath()
	...
	TriggerServerEvent('esx_firejob:setDeathStatus', true)
...
RegisterNetEvent('esx_firejob:useItem')
AddEventHandler('esx_firejob:useItem', function(itemName)
	ESX.UI.Menu.CloseAll()
	...
	if itemName == 'medikit' then
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			...
			TriggerEvent('esx_firejob:heal', 'big', true)
	...
	elseif itemName == 'bandage' then
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			...
			TriggerEvent('esx_firejob:heal', 'small', true)
...
function SendDistressSignal()
	...
	TriggerServerEvent('esx_firejob:onPlayerDistress')
end
...
function StartDeathTimer()
	...
	if Config.EarlyRespawnFine then
		ESX.TriggerServerCallback('esx_firejob:checkBalance', function(canPay)
			canPayFine = canPay
		end)
	end
	...
	CreateThread(function()
		...
		while bleedoutTimer > 0 and isDead do
			...
			elseif Config.EarlyRespawnFine and canPayFine then
				...
				if IsControlPressed(0, 38) and timeHeld > 60 then
					TriggerServerEvent('esx_firejob:payFine')
					RemoveItemsAfterRPDeath()
					break
				end
			end
...
function RemoveItemsAfterRPDeath()
	TriggerServerEvent('esx_firejob:setDeathStatus', false)
	...
	CreateThread(function()
		...
		ESX.TriggerServerCallback('esx_firejob:removeItemsAfterRPDeath', function()
